...
public class ByMappCoins : MonoBehaviour
{
    public AudioClip success, failBuy;
    public GameObject coins1000, coins5000, money0_99, money1_99, city_btn, megapolis_btn;
    public Animation coinsText;
    public Text coinsCount;
    public void ByMappWithCoins(int needCoins)
    {
        ...
        if (coins < needCoins)
        {
            ...
            {
                GetComponent<AudioSource>().clip = failBuy;
